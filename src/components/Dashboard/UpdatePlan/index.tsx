            ...
            <button
              ...
              className={classNames(
                'px-6 py-2 rounded-full transition-all font-medium',
                {
                  ...
                  'text-gray-600 hover:text-gray-900': billingCycle !== 'monthly'
                }
              )}
            >
              Tháng
            ...
            <button
              ...
              className={classNames(
                'px-6 py-2 rounded-full transition-all font-medium',
                {
                  ...
                  'text-gray-600 hover:text-gray-900': billingCycle !== 'yearly'
                }
              )}
            >
              Năm
                ...
                <div className={classNames(
                  ...
                  <ButtonCus
                    className={classNames(
                      ...
                      {
                        'bg-gray-600! hover:bg-gray-700!': plan.color === 'gray',
                        'bg-purple-600! hover:bg-purple-700!': plan.color === 'purple',
                        'bg-amber-600! hover:bg-amber-700!': plan.color === 'amber'
                      }
                    )}
                  >
